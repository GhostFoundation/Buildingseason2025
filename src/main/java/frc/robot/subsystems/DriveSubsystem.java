...
public class DriveSubsystem extends SubsystemBase {
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      ...
      Rotation2d.fromDegrees(-m_gyro.getAngle()),  //zonder - TODO 
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configure(
            ...
            new PPHolonomicDriveController( // PPHolonomicController is the built in path following controller for holonomic drive trains
                    ...
                    new PIDConstants(0.25,0, 0.3) // Rotation PID constants
            ),
  ...
  public void Turn(double speed){
    m_frontLeft.setDesiredState(new SwerveModuleState(speed, Rotation2d.fromDegrees(-45))); 
    m_frontRight.setDesiredState(new SwerveModuleState(-speed, Rotation2d.fromDegrees(45))); 
    m_rearLeft.setDesiredState(new SwerveModuleState(speed, Rotation2d.fromDegrees(45)));
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(-m_gyro.getYaw()).getDegrees(); //getAngle() zonder - TODO
  }
